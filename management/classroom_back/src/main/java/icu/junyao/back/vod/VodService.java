...
public class VodService {
    ...
    public void removeAlyVideo(String id) {
        try {
            ...
            e.printStackTrace();
            throw BusinessResponseEnum.VOD_DELETE_ERROR.newException();
        }
    }

    public void removeBatchAlyVideo(List<String> videoIdList) {
        try {
            //初始化对象
            DefaultAcsClient client = InitObject.initVodClient(ConstantVodUtils.ACCESS_KEY_ID, ConstantVodUtils.ACCESS_KEY_SECRET);
            //创建删除视频request对象
    ...
    public String gainPlayAuth(String id) {
        try {
            //创建初始化对象
            ...
            throw BusinessResponseEnum.FETCH_PLAY_AUTH_ERROR.newException();
        }
    }
}
